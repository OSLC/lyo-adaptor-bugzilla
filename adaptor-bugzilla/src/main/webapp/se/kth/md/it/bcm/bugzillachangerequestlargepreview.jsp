...
<head>
  ...
  <title><%= aBugzillaChangeRequest.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>product</dt>
            <dd><%= aBugzillaChangeRequest.productToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>component</dt>
            <dd><%= aBugzillaChangeRequest.componentToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>version</dt>
            <dd><%= aBugzillaChangeRequest.versionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>priority</dt>
            <dd><%= aBugzillaChangeRequest.priorityToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>platform</dt>
            <dd><%= aBugzillaChangeRequest.platformToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>operatingSystem</dt>
            <dd><%= aBugzillaChangeRequest.operatingSystemToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
