...
@OslcSchema ({
    ...
    @OslcNamespaceDefinition(prefix = BugzillaAdaptorConstants.OSLC_NAMSPACE_PREFIX, namespaceURI = BugzillaAdaptorConstants.OSLC_NAMSPACE),
    ...
    @OslcNamespaceDefinition(prefix = BugzillaAdaptorConstants.REQUIREMENTS_MANAGEMENT_NAMSPACE_PREFIX, namespaceURI = BugzillaAdaptorConstants.REQUIREMENTS_MANAGEMENT_NAMSPACE)
})
