...
public static URI constructURI(String serviceProviderId, String personId) throws URISyntaxException, UnsupportedEncodingException
{
	return new URI(ServletListener.getServicesBase() + "/" + serviceProviderId + "/persons/"+ personId);
}
...
public String toHtml()
{
    ...
    static public String nameToHtmlForCreation (final HttpServletRequest httpServletRequest, final String serviceProviderId)
    {
		String s = "";
    ...
    static public String givenNameToHtmlForCreation (final HttpServletRequest httpServletRequest, final String serviceProviderId)
    {
		String s = "";

		// Start of user code givenNameasHtmlForCreation_init
		// End of user code

		s = s + "<label for=\"givenName\">givenName: </LABEL>";

		// Start of user code givenNameasHtmlForCreation_mid
		// End of user code

				s= s + "<input name=\"givenName\" type=\"text\" style=\"width: 400px\" id=\"givenName\" >";

		// Start of user code givenNameasHtmlForCreation_finalize
		// End of user code

		return s; 
    }
    static public String familyNameToHtmlForCreation (final HttpServletRequest httpServletRequest, final String serviceProviderId)
    {
		String s = "";

		// Start of user code familyNameasHtmlForCreation_init
		// End of user code

		s = s + "<label for=\"familyName\">familyName: </LABEL>";

		// Start of user code familyNameasHtmlForCreation_mid
		// End of user code

				s= s + "<input name=\"familyName\" type=\"text\" style=\"width: 400px\" id=\"familyName\" >";

		// Start of user code familyNameasHtmlForCreation_finalize
		// End of user code
